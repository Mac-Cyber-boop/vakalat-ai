...
Plans:
- [x] 05-01-PLAN.md — Extended schema with lifecycle and versioning (TemplateStatus, ChangelogEntry)
- [x] 05-02-PLAN.md — Upload validation and versioning utilities (upload.py, versioning.py)
- [x] 05-03-PLAN.md — Lifecycle status management (change status, transition validation)
- [x] 05-04-PLAN.md — Template preview generation (TemplatePreview, FieldPreview)
- [x] 05-05-PLAN.md — API endpoints for template management (/upload, /history, /status, /preview)
...
Plans:
- [ ] 06-01-PLAN.md — Export module foundation (PDF + DOCX exporters with court formatting)
- [ ] 06-02-PLAN.md — Production error handling (ErrorResponse models + exception handlers)
- [ ] 06-03-PLAN.md — Export API endpoints (/export/pdf and /export/docx)
- [ ] 06-04-PLAN.md — Unified /draft-pro endpoint (generation + optional export)
...
| 5 | Template Management | TMPL-03, TMPL-04, TMPL-05, TMPL-06, TMPL-07 | Complete (5/5 plans) |
| 6 | Production Integration | DOC-05, DOC-06, PROD-01, PROD-02, PROD-03 | Planned (4 plans) |
...
*Updated: 2026-01-28 - Phase 6 planned (4 plans created)*
