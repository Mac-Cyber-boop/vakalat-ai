...
- Validates doc_type and court_level enums
...
3. /generate endpoint accepts doc_type, court_level, facts
4. /revise endpoint accepts content and instruction
5. Both endpoints use existing auth middleware
